...
class EbookController extends Controller
{
    public function store(Request $request){
        ...
        if (\Auth::user()->parent_id) {
            ...
            $va = new Va;
            $va->transactionMember(Auth::user()->id, $request->ebook_id, $renewal, 'member', $ebook->price, $no_invoice);
            ...
            $va = new Va;
            $va->transactionNonMember($id, $request->ebook_id, $renewal, 'nonmember', $ebook->price, $no_invoice);
