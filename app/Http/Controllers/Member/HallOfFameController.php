...
class HallOfFameController extends Controller
{
  public function index(Request $request){
    ...
    $data['platinum2'] = Employeer::where('rank_id',2)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(15, ['*'], 'page_2s');
    $data['platinum3'] = Employeer::where('rank_id',3)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(15, ['*'], 'page_3s');
    ...
    $data['director1'] = Employeer::where('rank_id',4)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(9, ['*'], 'page_4s');
    $data['director2'] = Employeer::where('rank_id',5)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(9, ['*'], 'page_5s');
    $data['director3'] = Employeer::where('rank_id',6)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(9, ['*'], 'page_6s');
    // $data['director3'] = Employeer::where('rank_id',6)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->paginate(3, ['*'], 'page_6s');
    $data['chairman1'] = Employeer::where('rank_id',7)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(2, ['*'], 'page_7s');
    $data['chairman2'] = Employeer::where('rank_id',8)->where('expired_at', '>', Carbon::now())->where('status','!=',0)->with('rank')->orderBy('first_name', 'asc')->paginate(1, ['*'], 'page_8s');
