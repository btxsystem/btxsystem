...
//     Route::post('checkReferral/{username}', 'MemberV2\ExploreController@checkReferral')->name('member.check-referral');
//     Route::post('checkUsername/{username}', 'MemberV2\ExploreController@checkUsername')->name('member.check-username');
// });