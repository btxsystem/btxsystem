...
var map = {
	"./views/customer/customer.module": [
		...
		"views-customer-customer-module~views-dashboard-dashboard-module~views-laporan-laporan-module~views-m~568f4b75",
		"views-customer-customer-module~views-laporan-laporan-module~views-member-member-module~views-pages-p~53971bbb",
		"views-customer-customer-module~views-laporan-laporan-module~views-member-member-module~views-trainin~9b26284e",
		"views-customer-customer-module~views-member-member-module~views-system-system-module~views-training-~04407718",
		"views-customer-customer-module"
	],
	...
	"./views/training/training.module": [
	...
	"./views/transaction/transaction.module": [
...
var navigation = [
        ...
        children: [
            {
                ...
                permission: 'Member.Member.View'
            },
            {
                name: 'Member Nonactive',
                url: '/member/member-nonactive',
                icon: 'fa fa-angle-double-right',
                permission: 'Member.Member.View'
            }
        ]
        ...
        children: [
            {
                ...
                icon: 'fa fa-angle-double-right',
                permission: 'Training.Management.View'
            },
            {
                name: 'Training Class',
                url: '/training/Class',
                icon: 'fa fa-angle-double-right',
                permission: 'Training.Class.View'
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                icon: 'fa fa-angle-double-right',
                permission: 'Bitrex.Points.View'
            },
            {
                name: 'Bitrex Cash',
                url: '/transaction/cash',
                icon: 'fa fa-angle-double-right',
                permission: 'Bitrex.Cash.View'
            }
        ]
    },
    // {
        ...
        children: [
            {
                ...
                url: '/system/password',
                icon: 'icon-key',
                permission: 'System.ChangePassword.View'
            },
            {
                name: 'Users',
                url: '/system/users',
    ...
    },
    {
        ...
        url: '/laporan/laporan',
        icon: 'fa fa-book',
        permission: 'Laporan.Laporan.View'
    }
];
...
/* harmony import */ var _app_injector__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./app.injector */ "./src/app/app.injector.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var APP_CONTAINERS = [
    _containers__WEBPACK_IMPORTED_MODULE_7__["FullLayoutComponent"],
    _containers__WEBPACK_IMPORTED_MODULE_7__["SimpleLayoutComponent"]
];
//  Import components
...
var APP_DIRECTIVES = [
    _directives__WEBPACK_IMPORTED_MODULE_9__["NAV_DROPDOWN_DIRECTIVES"],
    _directives__WEBPACK_IMPORTED_MODULE_9__["ReplaceDirective"],
    _directives__WEBPACK_IMPORTED_MODULE_9__["SIDEBAR_TOGGLE_DIRECTIVES"]
];
...
var AppModule = /** @class */ (function () {
    function AppModule(injector) {
        ...
        Object(_app_injector__WEBPACK_IMPORTED_MODULE_15__["appInjector"])(injector);
    }
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _components__WEBPACK_IMPORTED_MODULE_8__["AppBreadcrumbsComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppFooterComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppHeaderComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppSidebarComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppSidebarFooterComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppSidebarFormComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppSidebarHeaderComponent"],
                _components__WEBPACK_IMPORTED_MODULE_8__["AppSidebarMinimizerComponent"]
            ].concat(APP_CONTAINERS, APP_COMPONENTS, APP_DIRECTIVES),
            providers: [
                _angular_common__WEBPACK_IMPORTED_MODULE_3__["DecimalPipe"],
                _services_index__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"],
                ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_4__["BsModalService"],
                _services_index__WEBPACK_IMPORTED_MODULE_5__["AlertService"],
                _services_index__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"],
                _services_index__WEBPACK_IMPORTED_MODULE_5__["SessionService"],
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"],
                    useClass: _services_index__WEBPACK_IMPORTED_MODULE_5__["ExtendedHttpInterceptor"],
                    multi: true
                },
                {
...
var routes = [
    {
        ...
        pathMatch: 'full',
        canActivate: [_services_index__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    },
    {
        path: '',
    ...
    {
        path: 'pages',
        component: _containers__WEBPACK_IMPORTED_MODULE_3__["SimpleLayoutComponent"],
        data: {
            title: 'Pages'
        },
        children: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _alert_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alert.component */ "./src/app/components/alert/alert.component.ts");
...
/***/ "./src/app/components/app-back-button/app-back-button.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/components/app-back-button/app-back-button.component.ts ***!
  \*************************************************************************/
/*! exports provided: EsBackButtonComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EsBackButtonComponent", function() { return EsBackButtonComponent; });
...
var EsBackButtonComponent = /** @class */ (function () {
    function EsBackButtonComponent(location) {
        this.location = location;
    }
    EsBackButtonComponent.prototype.goBack = function () {
        this.location.back();
    };
    EsBackButtonComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-back-button',
            template: "<a (click)=\"goBack()\" class=\"btn btn-default btn-sm\"><i class=\"fas fa-chevron-left\"></i> Back</a> | ",
        }),
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_0__["Location"]])
    ], EsBackButtonComponent);
    return EsBackButtonComponent;
}());
...
/***/ "./src/app/components/app-back-button/index.ts":
/*!*****************************************************!*\
  !*** ./src/app/components/app-back-button/index.ts ***!
  \*****************************************************/
/*! exports provided: EsBackButtonComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_back_button_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-back-button.component */ "./src/app/components/app-back-button/app-back-button.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EsBackButtonComponent", function() { return _app_back_button_component__WEBPACK_IMPORTED_MODULE_0__["EsBackButtonComponent"]; });
...
/***/ "./src/app/components/app-confirm-modal/app-confirm-modal.component.html":
/*!*******************************************************************************!*\
  !*** ./src/app/components/app-confirm-modal/app-confirm-modal.component.html ***!
  \*******************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"confirm-box\">\r\n    <div class=\"modal-header\">\r\n        <h4 class=\"modal-title\">{{ title }}</h4>\r\n    </div>\r\n    <div class=\"modal-body\" style=\"background-color:#ccfccc\" *ngIf=\"color == 'green'\">\r\n\t\t<font style=\"font-size:20px\">{{ message }}</font>\r\n    </div>\r\n\t<div class=\"modal-body\" style=\"background-color:#fafae0\" *ngIf=\"color == 'yelow'\">\r\n\t\t<font style=\"font-size:20px\">{{ message }}</font>\r\n    </div>\r\n\t<div class=\"modal-body\" style=\"background-color:#f9d9d9\" *ngIf=\"color == 'red'\">\r\n\t\t<font style=\"font-size:20px\">{{ message }}</font>\r\n    </div>\r\n    <div class=\"modal-footer\" *ngIf=\"type == 'confirm'\">\r\n        <button type=\"button\" class=\"btn btn-secondary\" (click)=\"confirm()\">Yes</button>\r\n        <button type=\"button\" class=\"btn btn-secondary\" (click)=\"decline()\">No</button>\r\n    </div>\r\n    <div class=\"modal-footer\" *ngIf=\"type == 'alert'\">\r\n        <button type=\"button\" class=\"btn btn-secondary\" (click)=\"decline()\">Ok</button>\r\n    </div>\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/components/app-confirm-modal/app-confirm-modal.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/components/app-confirm-modal/app-confirm-modal.component.ts ***!
  \*****************************************************************************/
/*! exports provided: EsConfirmModalComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EsConfirmModalComponent", function() { return EsConfirmModalComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var EsConfirmModalComponent = /** @class */ (function () {
    function EsConfirmModalComponent(modalRef) {
        this.modalRef = modalRef;
        this.result = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    }
    EsConfirmModalComponent.prototype.confirm = function () {
        this.result.next(true);
        this.modalRef.hide();
    };
    EsConfirmModalComponent.prototype.decline = function () {
    ...
    ], EsConfirmModalComponent.prototype, "message", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], EsConfirmModalComponent.prototype, "title", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], EsConfirmModalComponent.prototype, "type", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], EsConfirmModalComponent.prototype, "color", void 0);
    EsConfirmModalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            moduleId: module.i,
            selector: 'app-confirm-modal',
            template: __webpack_require__(/*! ./app-confirm-modal.component.html */ "./src/app/components/app-confirm-modal/app-confirm-modal.component.html")
        }),
        __metadata("design:paramtypes", [ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_1__["BsModalRef"]])
    ], EsConfirmModalComponent);
    return EsConfirmModalComponent;
}());
...
/***/ "./src/app/components/app-confirm-modal/index.ts":
/*!*******************************************************!*\
  !*** ./src/app/components/app-confirm-modal/index.ts ***!
  \*******************************************************/
/*! exports provided: EsConfirmModalComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_confirm_modal_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-confirm-modal.component */ "./src/app/components/app-confirm-modal/app-confirm-modal.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EsConfirmModalComponent", function() { return _app_confirm_modal_component__WEBPACK_IMPORTED_MODULE_0__["EsConfirmModalComponent"]; });
...
module.exports = "<footer class=\"app-footer\">\r\n  <span class=\"ml-auto\">Powered by <a href=\"\">PT.HIER TEKNOLOGI </a></span>\r\n</footer>\r\n"
...
module.exports = "<header class=\"app-header navbar\">\r\n  <button class=\"navbar-toggler d-lg-none\" type=\"button\" appMobileSidebarToggler>\r\n    <span class=\"navbar-toggler-icon\"></span>\r\n  </button>&nbsp;\r\n  <!-- <a class=\"navbar-brand navbar-toggler  d-md-down-none\" style=\"color: #fff\"> Bitrex </a> -->\r\n  <img class=\"navbar-brand\" src=\"assets/img/logo.png\" >\r\n\r\n  <button class=\"navbar-toggler d-md-down-none\" type=\"button\" appSidebarToggler>\r\n    <span class=\"navbar-toggler-icon\"></span>\r\n  </button>&nbsp;\r\n  <ul class=\"nav navbar-nav d-md-down-none\">\r\n    <li class=\"nav-item px-3\">\r\n      <a class=\"nav-link\" href=\"#\">Dashboard</a>\r\n    </li>\r\n    <!--<li class=\"nav-item px-3\">\r\n      <a class=\"nav-link\" href=\"#\">Users</a>\r\n    </li>\r\n    <li class=\"nav-item px-3\">\r\n      <a class=\"nav-link\" href=\"#\">Settings</a>\r\n    </li>-->\r\n  </ul>\r\n  <ul class=\"nav navbar-nav ml-auto\">\r\n    <li class=\"nav-item\">\r\n        <button class=\"btn btn-info btn-sm\" ><i class=\"fa fa-book\"></i>\r\n          <span class=\"badge btn btn-danger\" style=\"border-radius: 50%;\">9</span> \r\n        </button>&nbsp;\r\n    </li>\r\n    <li class=\"nav-item\">\r\n        <button class=\"btn btn-warning btn-sm\" ><i class=\"fa fa-bell\"></i> \r\n        <span class=\"badge btn btn-danger\" style=\"border-radius: 50%;\"> 8 </span> \r\n      </button>&nbsp;\r\n    </li>\r\n    <li class=\"nav-item\"></li>\r\n\r\n    <li class=\"nav-item\">\r\n        <button class=\"btn btn-danger btn-sm\" (click)=\"logout()\"><i class=\"fa fa-lock\"></i> Logout</button>&nbsp;\r\n    </li>\r\n    <li class=\"nav-item\"></li>\r\n\r\n  </ul>\r\n</header>\r\n"
...
var AppHeaderComponent = /** @class */ (function () {
    function AppHeaderComponent(router, authenticationService) {
        this.router = router;
    ...
    AppHeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _services_index__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]])
    ], AppHeaderComponent);
...
var AppSidebarNavComponent = /** @class */ (function () {
    function AppSidebarNavComponent(authenticationService) {
        this.authenticationService = authenticationService;
    ...
    AppSidebarNavComponent.prototype.hasPermission = function (item) {
...
var AppSidebarNavLinkComponent = /** @class */ (function () {
    function AppSidebarNavLinkComponent(authenticationService) {
        this.authenticationService = authenticationService;
    }
    ...
    AppSidebarNavLinkComponent.prototype.hasPermission = function () {
        if (this.link.permission === null) {
            return true;
        }
        else {
            return this.authenticationService.hasPermission(this.link.permission);
        }
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
var AppSidebarNavDropdownComponent = /** @class */ (function () {
    function AppSidebarNavDropdownComponent(authenticationService) {
        this.authenticationService = authenticationService;
    }
    ...
    AppSidebarNavDropdownComponent.prototype.hasPermission = function (item) {
        if (item.permission === null) {
            return true;
        }
        else {
    ...
    AppSidebarNavDropdownComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: "\n    <a class=\"nav-link nav-dropdown-toggle\" appNavDropdownToggle *ngIf=\"hasPermission(link)\">\n      <i *ngIf=\"isIcon()\" class=\"{{ link.icon }}\"></i>\n      {{ link.name }}\n      <span *ngIf=\"isBadge()\" [ngClass]=\"'badge badge-' + link.badge.variant\">{{ link.badge.text }}</span>\n    </a>\n    <ul class=\"nav-dropdown-items\" style=\"margin-left: 20px\">\n      <ng-template ngFor let-child [ngForOf]=\"link.children\">\n        <app-sidebar-nav-item [item]='child' *ngIf=\"hasPermission(child)\"></app-sidebar-nav-item>\n      </ng-template>\n    </ul>\n  "
        }),
        __metadata("design:paramtypes", [_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]])
...
/* harmony import */ var _app_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app-header */ "./src/app/components/app-header/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppHeaderComponent", function() { return _app_header__WEBPACK_IMPORTED_MODULE_2__["AppHeaderComponent"]; });

/* harmony import */ var _app_sidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app-sidebar */ "./src/app/components/app-sidebar/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarComponent", function() { return _app_sidebar__WEBPACK_IMPORTED_MODULE_3__["AppSidebarComponent"]; });

/* harmony import */ var _app_sidebar_footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app-sidebar-footer */ "./src/app/components/app-sidebar-footer/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarFooterComponent", function() { return _app_sidebar_footer__WEBPACK_IMPORTED_MODULE_4__["AppSidebarFooterComponent"]; });

/* harmony import */ var _app_sidebar_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app-sidebar-form */ "./src/app/components/app-sidebar-form/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarFormComponent", function() { return _app_sidebar_form__WEBPACK_IMPORTED_MODULE_5__["AppSidebarFormComponent"]; });

/* harmony import */ var _app_sidebar_header__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app-sidebar-header */ "./src/app/components/app-sidebar-header/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarHeaderComponent", function() { return _app_sidebar_header__WEBPACK_IMPORTED_MODULE_6__["AppSidebarHeaderComponent"]; });

/* harmony import */ var _app_sidebar_minimizer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app-sidebar-minimizer */ "./src/app/components/app-sidebar-minimizer/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarMinimizerComponent", function() { return _app_sidebar_minimizer__WEBPACK_IMPORTED_MODULE_7__["AppSidebarMinimizerComponent"]; });

/* harmony import */ var _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app-sidebar-nav */ "./src/app/components/app-sidebar-nav/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarNavComponent", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["AppSidebarNavComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarNavItemComponent", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["AppSidebarNavItemComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarNavLinkComponent", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["AppSidebarNavLinkComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarNavDropdownComponent", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["AppSidebarNavDropdownComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AppSidebarNavTitleComponent", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["AppSidebarNavTitleComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "APP_SIDEBAR_NAV", function() { return _app_sidebar_nav__WEBPACK_IMPORTED_MODULE_8__["APP_SIDEBAR_NAV"]; });

/* harmony import */ var _app_back_button__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./app-back-button */ "./src/app/components/app-back-button/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EsBackButtonComponent", function() { return _app_back_button__WEBPACK_IMPORTED_MODULE_9__["EsBackButtonComponent"]; });

/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./alert */ "./src/app/components/alert/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AlertComponent", function() { return _alert__WEBPACK_IMPORTED_MODULE_10__["AlertComponent"]; });
...
/*!*************************************!*\
  !*** ./src/app/containers/index.ts ***!
  \*************************************/
/*! exports provided: FullLayoutComponent, SimpleLayoutComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _simple_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./simple-layout */ "./src/app/containers/simple-layout/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SimpleLayoutComponent", function() { return _simple_layout__WEBPACK_IMPORTED_MODULE_1__["SimpleLayoutComponent"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _simple_layout_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./simple-layout.component */ "./src/app/containers/simple-layout/simple-layout.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SimpleLayoutComponent", function() { return _simple_layout_component__WEBPACK_IMPORTED_MODULE_0__["SimpleLayoutComponent"]; });
...
/***/ "./src/app/directives/es-currency/es-currency.directive.ts":
/*!*****************************************************************!*\
  !*** ./src/app/directives/es-currency/es-currency.directive.ts ***!
  \*****************************************************************/
/*! exports provided: EsPriceFormatDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EsPriceFormatDirective", function() { return EsPriceFormatDirective; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var EsPriceFormatDirective = /** @class */ (function () {
    function EsPriceFormatDirective(elementRef, decimalPipe) {
    ...
    EsPriceFormatDirective.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            if (!isNaN(_this.el.value)) {
                _this.el.value = _this.decimalPipe.transform(_this.el.value);
            }
        }, 200);
    };
    EsPriceFormatDirective.prototype.onFocus = function (value) {
    ...
    EsPriceFormatDirective.prototype.onBlur = function (value) {
        if (!isNaN(value)) {
    ...
    ], EsPriceFormatDirective.prototype, "onFocus", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('blur', ['$event.target.value']),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], EsPriceFormatDirective.prototype, "onBlur", null);
    EsPriceFormatDirective = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({ selector: '[appEsPriceFormat]' }),
...
/***/ "./src/app/directives/es-currency/index.ts":
/*!*************************************************!*\
  !*** ./src/app/directives/es-currency/index.ts ***!
  \*************************************************/
/*! exports provided: EsPriceFormatDirective */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _es_currency_directive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./es-currency.directive */ "./src/app/directives/es-currency/es-currency.directive.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EsPriceFormatDirective", function() { return _es_currency_directive__WEBPACK_IMPORTED_MODULE_0__["EsPriceFormatDirective"]; });
...
/*!*************************************!*\
  !*** ./src/app/directives/index.ts ***!
  \*************************************/
/*! exports provided: NavDropdownDirective, NavDropdownToggleDirective, NAV_DROPDOWN_DIRECTIVES, ReplaceDirective, SidebarToggleDirective, SidebarMinimizeDirective, BrandMinimizeDirective, MobileSidebarToggleDirective, SidebarOffCanvasCloseDirective, SIDEBAR_TOGGLE_DIRECTIVES, EsPriceFormatDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _nav_dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nav-dropdown */ "./src/app/directives/nav-dropdown/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NavDropdownDirective", function() { return _nav_dropdown__WEBPACK_IMPORTED_MODULE_0__["NavDropdownDirective"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NavDropdownToggleDirective", function() { return _nav_dropdown__WEBPACK_IMPORTED_MODULE_0__["NavDropdownToggleDirective"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NAV_DROPDOWN_DIRECTIVES", function() { return _nav_dropdown__WEBPACK_IMPORTED_MODULE_0__["NAV_DROPDOWN_DIRECTIVES"]; });

/* harmony import */ var _replace__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./replace */ "./src/app/directives/replace/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ReplaceDirective", function() { return _replace__WEBPACK_IMPORTED_MODULE_1__["ReplaceDirective"]; });

/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sidebar */ "./src/app/directives/sidebar/index.ts");
...
/* harmony import */ var _es_currency__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./es-currency */ "./src/app/directives/es-currency/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EsPriceFormatDirective", function() { return _es_currency__WEBPACK_IMPORTED_MODULE_3__["EsPriceFormatDirective"]; });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _components_app_confirm_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/app-confirm-modal */ "./src/app/components/app-confirm-modal/index.ts");
...
var AlertService = /** @class */ (function () {
    function AlertService(bsModalService) {
        this.bsModalService = bsModalService;
    }
    AlertService.prototype.confirm = function (message) {
        var modal = this.bsModalService.show(_components_app_confirm_modal__WEBPACK_IMPORTED_MODULE_1__["EsConfirmModalComponent"], {
            initialState: { title: 'Confirm', message: message, type: 'confirm', color: 'green' }
        });
        return new Promise(function (resolve, reject) { return modal.content.result.subscribe(function (result) { return resolve(result); }); });
    };
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/login', JSON.stringify({ username: username, password: password }))
    ...
    AuthenticationService.prototype.hasPermission = function (permissionName) {
        var permissions = JSON.parse(localStorage.getItem('permissions'));
        if (permissions && permissions.length > 0) {
            var permission = permissions.find(function (res) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _system_base_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../system/base.service */ "./src/app/services/system/base.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
...
}(_system_base_service__WEBPACK_IMPORTED_MODULE_1__["BaseService"]));



/***/ }),

/***/ "./src/app/services/extended-http.service.ts":
/*!***************************************************!*\
  !*** ./src/app/services/extended-http.service.ts ***!
  \***************************************************/
/*! exports provided: ExtendedHttpInterceptor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExtendedHttpInterceptor", function() { return ExtendedHttpInterceptor; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var ExtendedHttpInterceptor = /** @class */ (function () {
    function ExtendedHttpInterceptor(router) {
        this.router = router;
    }
    ExtendedHttpInterceptor.prototype.intercept = function (request, next) {
        var _this = this;
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (ev) {
    ...
    ExtendedHttpInterceptor.prototype.clearToken = function () {
        //  remove user from local storage to log user out
        localStorage.removeItem('currentUser');
    };
    ExtendedHttpInterceptor.prototype.getToken = function () {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        if (currentUser && currentUser.token) {
            return currentUser.token;
        }
    ...
    ExtendedHttpInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], ExtendedHttpInterceptor);
    return ExtendedHttpInterceptor;
}());
...
/*!***********************************!*\
  !*** ./src/app/services/index.ts ***!
  \***********************************/
/*! exports provided: AuthGuard, AlertService, AuthenticationService, UsersService, RolesService, PermissionsService, SessionService, LaporanService, SettingService, MemberService, RankService, CustomerService, TrainingService, ExtendedHttpInterceptor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.guard */ "./src/app/services/auth.guard.ts");
...
/* harmony import */ var _roles_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./roles.service */ "./src/app/services/roles.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RolesService", function() { return _roles_service__WEBPACK_IMPORTED_MODULE_4__["RolesService"]; });

/* harmony import */ var _permissions_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./permissions.service */ "./src/app/services/permissions.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PermissionsService", function() { return _permissions_service__WEBPACK_IMPORTED_MODULE_5__["PermissionsService"]; });

/* harmony import */ var _system_session_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./system/session.service */ "./src/app/services/system/session.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SessionService", function() { return _system_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"]; });

/* harmony import */ var _laporan_laporan_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./laporan/laporan.service */ "./src/app/services/laporan/laporan.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LaporanService", function() { return _laporan_laporan_service__WEBPACK_IMPORTED_MODULE_7__["LaporanService"]; });

/* harmony import */ var _setting_setting_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./setting/setting.service */ "./src/app/services/setting/setting.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SettingService", function() { return _setting_setting_service__WEBPACK_IMPORTED_MODULE_8__["SettingService"]; });

/* harmony import */ var _member_member_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./member/member.service */ "./src/app/services/member/member.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MemberService", function() { return _member_member_service__WEBPACK_IMPORTED_MODULE_9__["MemberService"]; });

/* harmony import */ var _member_rank_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./member/rank.service */ "./src/app/services/member/rank.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RankService", function() { return _member_rank_service__WEBPACK_IMPORTED_MODULE_10__["RankService"]; });

/* harmony import */ var _customer_customer_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./customer/customer.service */ "./src/app/services/customer/customer.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CustomerService", function() { return _customer_customer_service__WEBPACK_IMPORTED_MODULE_11__["CustomerService"]; });

/* harmony import */ var _training_trainings_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./training/trainings.service */ "./src/app/services/training/trainings.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TrainingService", function() { return _training_trainings_service__WEBPACK_IMPORTED_MODULE_12__["TrainingService"]; });

/* harmony import */ var _extended_http_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./extended-http.service */ "./src/app/services/extended-http.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ExtendedHttpInterceptor", function() { return _extended_http_service__WEBPACK_IMPORTED_MODULE_13__["ExtendedHttpInterceptor"]; });
...
/***/ "./src/app/services/laporan/laporan.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/laporan/laporan.service.ts ***!
  \*****************************************************/
/*! exports provided: LaporanService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LaporanService", function() { return LaporanService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../environments/environment */ "./src/environments/environment.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var LaporanService = /** @class */ (function () {
    function LaporanService(http) {
        this.http = http;
    }
    LaporanService.prototype.generate = function (tipe, request) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/laporan/' + tipe, request);
    };
...
/***/ "./src/app/services/member/rank.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/member/rank.service.ts ***!
  \*************************************************/
/*! exports provided: RankService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RankService", function() { return RankService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _system_base_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../system/base.service */ "./src/app/services/system/base.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
var __extends = (undefined && undefined.__extends) || (function () {
...
var RankService = /** @class */ (function (_super) {
    __extends(RankService, _super);
    function RankService(httpClient) {
        var _this = _super.call(this, httpClient) || this;
        _this.endPoint = 'rank';
        return _this;
    }
...
var PermissionsService = /** @class */ (function () {
    ...
    PermissionsService.prototype.get = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/permissions');
    };
    PermissionsService.prototype.save = function (request) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/permissions', request);
    };
    PermissionsService.prototype.update = function (request, primaryKey) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/permissions/' + primaryKey, request);
    };
    PermissionsService.prototype.delete = function (primaryKey) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/permissions/' + primaryKey);
    };
...
var RolesService = /** @class */ (function () {
    ...
    RolesService.prototype.get = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/roles');
    };
    RolesService.prototype.save = function (request) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/roles', request);
    };
    RolesService.prototype.update = function (request, primaryKey) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/roles/' + primaryKey, request);
    };
    RolesService.prototype.delete = function (primaryKey) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/roles/' + primaryKey);
    };
...
var SettingService = /** @class */ (function (_super) {
    ...
    function SettingService(httpClient) {
        var _this = _super.call(this, httpClient) || this;
        _this.endPoint = 'setting';
        return _this;
    }
...
/***/ "./src/app/services/system/base.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/system/base.service.ts ***!
  \*************************************************/
...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.get = function (filters) {
        ...
        return this.http.get(this.env.appUrl + '/' + this.endPoint, { params: httpParams });
    };
    BaseService.prototype.save = function (request) {
        return this.http.post(this.env.appUrl + '/' + this.endPoint, request);
    };
    BaseService.prototype.update = function (request, primaryKey) {
        return this.http.put(this.env.appUrl + '/' + this.endPoint + '/' + primaryKey, request);
    };
    BaseService.prototype.delete = function (primaryKey) {
        return this.http.delete(this.env.appUrl + '/' + this.endPoint + '/' + primaryKey);
    };
    BaseService.prototype.getDetail = function (primaryKey) {
        return this.http.get(this.env.appUrl + '/' + this.endPoint + '/detail/' + primaryKey);
    };
    return BaseService;
}());
...
var SessionService = /** @class */ (function () {
     ...
     * @param value
     */
    SessionService.prototype.setSession = function (key, value) {
     ...
     * @param persistance
     */
    SessionService.prototype.getSession = function (key, persistance) {
     ...
     * @param key
     */
    SessionService.prototype.clearSession = function (key) {
...
/***/ "./src/app/services/training/trainings.service.ts":
/*!********************************************************!*\
  !*** ./src/app/services/training/trainings.service.ts ***!
  \********************************************************/
...
var TrainingService = /** @class */ (function (_super) {
    ...
    function TrainingService(httpClient) {
        var _this = _super.call(this, httpClient) || this;
        _this.endPoint = 'training';
        return _this;
    }
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.get = function (filters) {
        var httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        Object.keys(filters).forEach(function (key) {
            httpParams = httpParams.append(key, filters[key]);
        });
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/users', { params: httpParams });
    };
    UsersService.prototype.save = function (request) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/users', request);
    };
    UsersService.prototype.update = function (request, primaryKey) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/users/' + primaryKey, request);
    };
    UsersService.prototype.delete = function (primaryKey) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/users/' + primaryKey);
    };
    UsersService.prototype.password = function (request, primaryKey) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].appUrl + '/users/password/' + primaryKey, request);
    };
...
var environment = {
    production: false,
    appUrl: 'http://dev.bitrexgo.id/api',
    imageUrl: 'http://localhost/bitrexgo/public/storage'
};
...
module.exports = __webpack_require__(/*! D:\jws\bgAdmin\src\main.ts */"./src/main.ts");
