...
<body>
  ...
  <table>
    <tr>
      <td>First Name</td>
      <td>: <strong>{{$data->nonMember->first_name}}</strong></td>
    </tr>
    <tr>
      <td>Last Name</td>
      <td>: <strong>{{$data->nonMember->last_name}}</strong></td>
    </tr>
    <tr>
      <td>Username</td>
      <td>: <strong>{{$data->nonMember->username}}</strong></td>
    </tr>
    <tr>
      <td>Email</td>
      <td>: <strong>{{$data->nonMember->email}}</strong></td>
    </tr>
    <tr>
      <td>Phone</td>
      <td>: <strong>081517677046</strong></td>
    </tr>
  </table>
  <h3>EBOOK ACCESS</h3>
  <table>
    ...
    <tr>
      <td>Password</td>
      <td>: <strong>{{$additional != null ? $additional->password : 'Your Current Password'}}</strong></td>
    </tr>
    <tr>
      <td>Ebook Type</td>
