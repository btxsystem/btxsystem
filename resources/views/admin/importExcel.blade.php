...
<form method="post" action="{{route('import.curse')}}" enctype="multipart/form-data">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Import bonus cruise</h5>
		</div>
		<div class="modal-body">
...
<form method="post" action="{{route('import.old-bonus')}}" enctype="multipart/form-data">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Import bonus old</h5>
		</div>
		<div class="modal-body">
...
<form method="post" action="{{route('import.account-name')}}" enctype="multipart/form-data">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Import bonus old</h5>
		</div>
