        ...
        <div class="container">
                <table class="table table-striped">
                   <tbody>
                      <tr>
                         <td colspan="1">
                         <form action="{{ route('admin-management.roles.update') }}" class="well form-horizontal" method="POST" enctype="multipart/form-data">
                            @csrf
                            <fieldset>
                                ...
                                <label class="col-md-2 control-label">Role Name</label>
                                    <div class="col-md-8 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input id="role" name="role_id" placeholder="Role Name" style="display:none" class="form-control" required="true" value="{{$role->id}}" type="text">
                                            <input id="role" name="title" placeholder="Role Name" class="form-control" required="true" value="{{$role->title}}" type="text">
                                        </div>
                                    </div>
                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <label>
                                                                    <input type="checkbox" name="permissions[]" value="112"/>Refund
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label>
