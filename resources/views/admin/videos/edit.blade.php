                        ...
                        <form class="well form-horizontal" id="form-video" method="post" action="{{route('video.update', $data->id)}}" enctype="multipart/form-data">
                           ...
                           <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input id="video" name="path" placeholder="Video" class="form-control" required="true" value="{{$data->path}}" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                <label class="col-md-2 control-label">Video</label>
                                <div class="col-md-8 inputGroupContainer">
                                    <input id="path" name="path" class="form-control" value="{{old('path')}}" type="file">
