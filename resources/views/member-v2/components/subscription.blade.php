				...
				<div class="col-lg-6 mb-3">
					...
					<div class="shadow rounded p-3 border-hover bg-white triangle">
                      ...
                      <input type="hidden" name="repeat" value="true">
											...
											<button onclick="changeValueRepeat(JSON.stringify({'price': '{{$ebook->price}}', 'price_markup': '{{$ebook->price_markup}}', 'id': '{{$ebook->id}}'}))" data-toggle="modal" data-target="#repeatModal" type="button" class="btn btn-identity-red text-white btn-sm mt-3 px-5">REPEAT ORDER</button>
											@if($ebook->id == 1 && $expired_basic != null || $ebook->id == 2 && $expired_advanced!= null)
