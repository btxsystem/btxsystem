                ...
                success:function(data){
                    ...
                    if (data[0]==undefined) {
                        ...
                        $.each(data, function(i, item) {
                            ...
                            $('#bill').append('<div class="card ke-'+i+'" style="border: 1px solid #ccc; box-shadow: 1px 1px 3px 0px  rgba(0,0,0,0.3);"><div class="body"><div class="row"><strong class="col-sm-4" id="date">Date Time: '+date+'</strong></div><hr><div class="row"><div class="col" id="nominal">Nominal: '+nominal+'</div><hr></div><div class="row"><div class="col" id="description">Description: '+item.description.replace("Bonus Sponsor", "Sponsor's Commission")+'</div></div></div>');
                        });
                    }
                }
            });
