<nav class="navbar">
    <div class="col-12">
        ...
        <ul class="nav navbar-nav navbar-right">
           <li style="font-size:13px"><a href="/logout" title="sign out" style="text-decoration:none" class="logout"><strong>Logout</strong>&nbsp; <i class="fa fa-sign-out" style="color:red"></i></a></li>
        </ul>
    </div>
</nav>
